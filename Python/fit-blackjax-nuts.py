#!/usr/bin/env python3
# fit-blackjax-nuts.py
# Fit using NUTS from BlackJAX
...
print("Next, NUTS. Be patient...")
      
def mcmc(init, kernel, iters = 10000):
...
samp = blackjax.nuts(lpost, 1e-3, pre)
...
plt.savefig("blackjax-nuts-trace.png")
#plt.show()
...
plt.savefig("blackjax-nuts-hist.png")
#plt.show()
...
plt.savefig("blackjax-nuts-acf.png")
#plt.show()

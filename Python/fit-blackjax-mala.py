#!/usr/bin/env python3
# fit-blackjax-mala.py
# Fit using MALA from BlackJAX
...
samp = blackjax.mala(lpost, 4e-6)
bjInit = samp.init(beta)
out = mcmc(bjInit, samp, jit(samp.step), thin=50000)
...
plt.savefig("blackjax-mala-trace.png")
#plt.show()
...
plt.savefig("blackjax-mala-hist.png")
#plt.show()
...
plt.savefig("blackjax-mala-acf.png")
#plt.show()
